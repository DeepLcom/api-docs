...
## [Unreleased]
### Added
* Add new OpenAPI spec `jobs-voice-translate.openapi.yaml` for the async voice translation API (`POST /v1/jobs/voice/translate`, `GET /v1/jobs/voice/translate/{job_id}`)
