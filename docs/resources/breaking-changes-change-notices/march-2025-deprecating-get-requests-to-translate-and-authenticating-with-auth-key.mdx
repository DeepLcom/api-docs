---
title: "March 2025: Deprecating GET Requests To /Translate And Authenticating With Auth\_key"
---
...
[This example from the documentation](https://developers.deepl.com/docs/api-reference/translate) shows an HTTP POST request to translate the English sentence "Hello, world!" into German.
