---
title: "Release Notes"
description: "Brief summaries of recent DeepL API releases, such as support for new languages and document formats, new API parameters, and more."
---
...
- Added support for new language: TH (Thai). For this release, this language will only support text translation. See [here](../getting-started/supported-languages.md) for more information.
- Added support for new languages: HE (Hebrew) and VI (Vietnamese). For this release, these languages will be available for Pro v2 API in next-gen models only. See [here](../getting-started/supported-languages.md) for more information.
- Added improvements to API glossaries, including the ability to edit glossaries and create multilingual glossaries. Learn more [here](../api-reference/glossaries/).
- Improvements to the `/usage` endpoint for Pro API customers ([API reference](../api-reference/usage-and-quota/))
- Improvements to key-level usage reporting, making it possible to pull reports with a custom date range and to group data by calendar day. Learn more [here](../getting-started/managing-api-keys.md#get-api-key-level-usage).&#x20;
</Update>

<Update label="Q1 2025">
- Added support for API key-level usage limits, making it possible to set a character limit at the API key-level. Learn more [here](../getting-started/managing-api-keys.md#set-api-key-level-usage-limits).
...
- Added the `model_type` parameter, allowing users to translate text with DeepL's "next-gen" translation models. More information can be found [here](/docs/api-reference/translate#about-the-model_type-parameter).
</Update>

<Update label="Q3 2024">
- Added the `show_billed_characters` parameter for text translation, allowing users to optionally include the number of billed characters in the API response. [Learn more here](/docs/api-reference/translate#request-body-descriptions).
...
- Moved the `context` parameter from [alpha](/docs/getting-started/alpha-and-beta-features) status to general availability. More information about the context parameter is available in the "Request body descriptions" table [here](/docs/api-reference/translate).
- Added support for SRT (`srt`) files in [document translation](/docs/api-reference/document).
</Update>
...
- Added support for Korean (KO) as a [glossary](/docs/api-reference/glossaries) language, increasing the number of supported glossary language pairs from 55 to 66.
</Update>

<Update label="Q4 2023">
- Added support for Microsoft Excel (`xlsx`) files in [document translation](/docs/api-reference/document).
- Released the `context` parameter as an [alpha feature](/docs/getting-started/alpha-and-beta-features) for text translation (see [Request Body Descriptions table](/docs/api-reference/translate#request-body-descriptions) for more information).
</Update>
...
- Added support for Portuguese (PT), Russian (RU), and Chinese (ZH) as [glossary](/docs/api-reference/glossaries) languages, increasing the number of supported glossary language pairs from 28 to 55.
...
- Added formality support for Japanese (JA) in [text](/docs/api-reference/translate) and [document](/docs/api-reference/document) translation.
...
- Added XLIFF as a [document translation](/docs/api-reference/document) format (*note that only documents from version 2.0 are supported, and there is no support for the legacy 1.2 format*).
...
- Added support for JSON-encoded requests for [text translation](/docs/api-reference/translate), [usage](/docs/api-reference/usage-and-quota), and [languages](/docs/api-reference/languages) endpoints.
</Update>

<Update label="Q3 2022">
- Released an official [PHP client library](https://github.com/DeepLcom/deepl-php).
- Added support for a new language for [text](/docs/api-reference/translate) and [document](/docs/api-reference/document) translation: UK (Ukrainian). [Blog post here](https://www.deepl.com/en/blog/deepl-learns-ukrainian).
</Update>
...
- Added support for [glossaries](/docs/api-reference/glossaries) in the DeepL API.
