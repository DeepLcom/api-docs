...
- Added support for Korean (KO) as a [glossary](/api-reference/glossaries) language, increasing the number of supported glossary language pairs from 55 to 66.
</Update>
...
- Added support for Portuguese (PT), Russian (RU), and Chinese (ZH) as [glossary](/api-reference/glossaries) languages, increasing the number of supported glossary language pairs from 28 to 55.
...
- Added support for [glossaries](/api-reference/glossaries) in the DeepL API.
