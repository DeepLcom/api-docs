...
- Add usage analytics in the Admin API, including key-level reporting.
- Allow multiple admins in an API subscription
- Add support for custom rules in the API to programmatically manage and translate using custom rules.
</Update>
