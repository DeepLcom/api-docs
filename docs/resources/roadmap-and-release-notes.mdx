...
- Full CRUD functionality for managing [Translation Memories](/api-reference/translation-memory/list-translation-memories) via API (list endpoint now available)
...
- Added support for [translation memories](/docs/learning-how-tos/examples-and-guides/how-to-use-translation-memories) in the DeepL API, making it possible to list translation memories and use them in text translation requests.
- New `translation_memory_id` and `translation_memory_threshold` parameters added to the [text translation endpoint](/api-reference/translate/request-translation).
- New `GET /v3/translation_memories` endpoint to retrieve translation memories associated with your account.
- Full CRUD endpoints for managing translation memories via the API will follow.
</Update>
