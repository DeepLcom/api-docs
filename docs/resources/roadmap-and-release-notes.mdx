...
- Full CRUD functionality for managing [Style Rules](api-reference/style-rules.mdx) and [Custom Instructions](api-reference/translate/request-translation#body-custom-instructions)
