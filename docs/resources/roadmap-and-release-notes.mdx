...
- The [Voice API](/api-reference/voice) is now available to all Pro API customers. This API provides real-time speech transcription and translation and can be used with any existing DeepL Pro API key.
