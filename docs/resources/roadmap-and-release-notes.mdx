...
- Full CRUD functionality for managing [Translation Memories](/api-reference/translation-memory) via API (list endpoint now available)
...
- Added support for [translation memories](/api-reference/translation-memory) in the DeepL API, making it possible to list translation memories and use them in text translation requests.
