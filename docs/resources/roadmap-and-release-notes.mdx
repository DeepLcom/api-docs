...
## April 30 - German (Swiss) and French (Canadian) enter Beta
- `de-CH` (German, Swiss) and `fr-CA` (French, Canadian) have moved to Beta. Prior to April 30, these languages were generally available and billed normally.
- During the Beta phase, characters translated into these languages are not billed and do not count against your character threshold.
