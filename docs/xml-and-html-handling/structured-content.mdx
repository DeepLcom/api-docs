...
Restricted SplittingWith Splitting
...
ℹ️ Translating separately results in an incorrect translation. As this can lead to bad translations, this type of structure should either be avoided, or the `non_splitting_tags` parameter should be set.
