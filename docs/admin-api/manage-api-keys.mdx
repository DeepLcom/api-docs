...
<Info>
This page describes managing API keys in the self-admin area. Additionally, an Admin API for API key management is 
available to a limited set of Pro API customers. Learn more [here](/api-reference/admin-api).
</Info>
