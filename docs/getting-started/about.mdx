...
<Info>
For information about API updates and improvements, please refer to our [release notes](/docs/getting-started/resources/release-notes.md).
</Info>
...
* **High-quality text and document translations**: DeepL [consistently outperforms the competition](https://www.deepl.com/quality.html) in translation quality—and not only for text translation. The API also supports [.docx, .pptx, .xlsx, .txt, PDF, and HTML](/docs/getting-started/api-reference/document/README.md) files.
...
* **Customization with glossaries**: [Specify your own translations for words and phrases](/docs/getting-started/api-reference/glossaries/README.md), and customize your translations consistently and at scale.
