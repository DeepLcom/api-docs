...
<Info>
For information about API updates and improvements, please refer to our [release notes](https://github.com/DeepLcom/deepl-api-docs/blob/main/getting-started/resources/release-notes.md).
</Info>
...
* **Customization with glossaries**: [Specify your own translations for words and phrases](https://github.com/DeepLcom/deepl-api-docs/blob/main/getting-started/api-reference/glossaries/README.md), and customize your translations consistently and at scale.
