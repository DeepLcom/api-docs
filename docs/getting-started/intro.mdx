...
<Steps>
  ...
  <Step title="Step 2: Test your API key with a request" titleSize="h3">
    Find your API key [here](https://www.deepl.com/en/your-account/keys). Then try making a translation request to the API using cURL, an HTTP request, or any of six popular programming languages. You can use the sample code below, making sure to replace `{YOUR_API_KEY}` with your own API key.
