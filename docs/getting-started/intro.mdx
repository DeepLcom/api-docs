...
<Steps>
  ...
  <Step title="Step 2: Test your API key with a request" titleSize="h3">
    Next, try making a translation request to the API using cURL or six popular programming languages. Choose your favorite, making sure to replace`{YOUR_API_KEY}`with your own API key. You can find your API key [here](https://www.deepl.com/en/your-account/keys).
