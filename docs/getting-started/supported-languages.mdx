...
<Info>
If trying to convert between variants of the same language (e.g. `EN-US` to `EN-GB`), please consider using the [/write/rephrase](/api-reference/improve-text) API. Please see [here](/api-reference/improve-text#param-target-lang) for supported target languages for this use case.
</Info>
