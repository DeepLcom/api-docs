...
We recommend the /usage endpoint ([docs](/docs/api-reference/usage-and-quota)) to see near-real-time character consumption data.
</Info>
...
<Frame caption="Select the <q>Group by</q> day option to group key-level usage data by UTC calendar day">
