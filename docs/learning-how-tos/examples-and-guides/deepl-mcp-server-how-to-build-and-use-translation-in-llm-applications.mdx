---
title: "DeepL MCP Server: How to build and use translation in LLM applications"
description: >-
  Efficiently translate content with AI-powered translation and enhance your
  interactions with large language models.
sidebarTitle: "DeepL MCP Server"
public: true
---

<Info>
  This cookbook is intended for developers who want to learn how to build an MCP server using the DeepL API. If you're looking to simply use a pre-built DeepL MCP server without building it yourself, please go directly to the [GitHub repository](https://github.com/DeepLcom/deepl-mcp-server) for installation instructions.
</Info>
...
<Step title="Create Your Server Implementation">
...
<Step title="Implement DeepL API Helper Functions">
...
<Frame caption='Your MCP should show up in the "Search and Tools" menu.'>
  <img src="/_assets/images/claude-desktop-menu.jpeg" alt=""/>
</Frame>
...
<Frame caption='Using the "DeepL" keyword triggers Claude to use the DeepL MCP tools.'>
  <img src="/_assets/images/claude-desktop-keyword-trigger.jpeg" alt=""/>
</Frame>
...
<CardGroup>
  <Card icon="code" horizontal href="https://www.deepl.com/pro-api">
    DeepL API
  </Card>
  <Card icon="lightbulb-gear" horizontal href="https://modelcontextprotocol.io/">
    Model Context Protocol
  </Card>
  <Card icon="code-branch" horizontal href="https://github.com/DeepLcom/deepl-mcp-server">
    DeepL MCP Server GitHub
  </Card>
  <Card icon="microchip-ai" horizontal href="https://modelcontextprotocol.io/quickstart/server#testing-your-server-with-claude-for-desktop">
