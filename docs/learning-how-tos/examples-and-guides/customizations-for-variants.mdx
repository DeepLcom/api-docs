...
See [supported glossary languages](/docs/getting-started/supported-languages) for the full list.
...
The following example creates and applies 2 glossaries to use different terms for "invoice" in Brazilian and European Portuguese:
