...
Now let's use that translation memory in a translation request. Add the `translation_memory_id` parameter to your call to the [text translation endpoint](/api-reference/translate/request-translation).
...
- [Text translation endpoint](/api-reference/translate/request-translation) — `translation_memory_id` and `translation_memory_threshold` parameter reference
