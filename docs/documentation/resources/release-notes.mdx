...
* API key-level character limits

* Improvements to the `/usage`endpoint ([API reference](/docs/api-reference/usage-and-quota))

#### Q1 2025

* DeepL API for Write is generally available to Pro API customers, making it possible to improve texts in (at the time of release) 6 different languages. Learn more and get started [here](/docs/api-reference/improve-text).
