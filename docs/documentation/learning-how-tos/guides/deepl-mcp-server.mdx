...
<img src="/images/claude-desktop-menu.jpeg" alt=""/>

<div class="flex items-center justify-center m-0">
  <p class="p-0 m-0">Your MCP should show up in the "Search and Tools" menu.</p>
</div>
...
<img src="/images/claude-desktop-keyword-trigger.jpeg" alt=""/>

<div class="flex items-center justify-center m-0">
  <p class="p-0 m-0">Using the "DeepL" keyword triggers Claude to use the DeepL MCP tools.</p>
</div>
