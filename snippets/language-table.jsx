export const LanguageTable = () => {
    ...
    const FeatureBadges = ({ lang }) => {
        const features = [
            ...
            { key: 'glossaries', label: 'Create Glossaries' },
            { key: 'translateGlossaries', label: 'Translation: Glossaries', isTranslateWith: true },
            ...
            { key: 'styleRules', label: 'Create Style Rules' },
            { key: 'translateStyleRules', label: 'Translation: Style Rules', isTranslateWith: true },
        ]
        return (
            <div className="flex flex-wrap gap-1.5">
                {features.map(f => {
                    ...
                    if (lang[f.key]) {
                        return (
                            <span key={f.key} className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                                f.isTranslateWith
