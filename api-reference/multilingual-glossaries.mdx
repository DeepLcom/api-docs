...
Currently you can create glossaries with [any of the languages DeepL supports](../../getting-started/supported-languages).  Any updates will be noted here, as well as in [the /languages endpoint and documentation](../../getting-started/supported-languages).
