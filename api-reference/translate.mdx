...
<ParamField body="model_type" type="enum">
  ...
  <p>
    Note: <a href="/docs/xml-and-html-handling/tag-handling-v2">tag handling v2</a> is compatible only with next-gen models, and the default `model_type` value is implictly changed to `quality_optimized` for tag handling v2 requests.
