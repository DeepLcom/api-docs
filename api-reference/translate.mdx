...
To learn more about using translation memories in your translation requests, see the [translation memory overview](/api-reference/translation-memory).
...
<ParamField body="translation_memory_id" type="string">
  Specify the translation memory to use for the translation. The value should be the UUID of a translation memory associated with your account. You can retrieve your translation memory IDs using the [list translation memories endpoint](/api-reference/translation-memory/list-translation-memories).
  <Info>
...
<ParamField body="translation_memory_threshold" type="integer">
  The minimum matching percentage required for a translation memory segment to be applied. Accepts values from 0 to 100. We recommend a minimum threshold of **75%**. Default: `75`. See the [translation memory overview](/api-reference/translation-memory) for more details.
</ParamField>
