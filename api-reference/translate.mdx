...
<ParamField body="customization_id" type="string">
  Specify the custom rule list to use for the translation.
  <Note>
    <strong>Important:</strong> The <code>target_lang</code> parameter must match the language of the custom rule list.
  </Note>
</ParamField>
