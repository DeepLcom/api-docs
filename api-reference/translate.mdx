...
<Info>
  ...
  If trying to translate between variants of the same language (e.g. `en-us` to `en-gb`), please consider using the [/write/rephrase](/api-reference/improve-text) API instead.
</Info>
