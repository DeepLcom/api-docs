...
<Warning>
  **Beta Feature — Opt-in Required**
  ...
  The Detect Language API is currently in beta and requires explicit opt-in for your account. To request access, please contact [**{{EMAIL_PLACEHOLDER}}**](mailto:{{EMAIL_PLACEHOLDER}}).
</Warning>
