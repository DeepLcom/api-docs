...
All source languages can be translated to all [DeepL Translate supported languages](/docs/getting-started/supported-languages#translation-target-languages).
...
* Recommended chunk duration: 50-250 ms for low latency
