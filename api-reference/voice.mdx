...
<Warning>
    ...
    which you must therefore specify explicitly. [Spoken terms](#customization) are also not yet supported.
</Warning>
...
* <Badge color="blue">beta</Badge> **Spoken terms** — Improve transcription of frequently used terms like company-specific terminology, acronyms, product names, and team member names. Manage in [DeepL Home](https://www.deepl.com/en/voice/spoken-terms); management via API coming soon.
